...
import useClickOutside from "@/hooks/use-client-outside"
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              layoutId={`popover-${uniqueId}`}
              className="absolute top-1/2 -translate-x-1/2 -translate-y-1/2 left-1/2 h-[200px] w-[364px] overflow-hidden border border-zinc-950/10 bg-white outline-none dark:bg-zinc-700"
            ...
            >
              ...
              >
                ...
                <div key="close" className="flex justify-between px-4 py-3">
                  ...
                  >
                    <ArrowLeftIcon className="size-4 text-zinc-900 dark:text-zinc-100" />
                  </button>
                  <button
